...
class ConnectionManager
{
	...
	{
		return $this->byId( "vmvidros_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "vmvidros_at_localhost";
		$data["connName"] = "vmvidros at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;vmvidros;;1"; //currently unused
		
		$this->_connectionsIdByName["vmvidros at localhost"] = "vmvidros_at_localhost";
...
;
		$connectionsData["vmvidros_at_localhost"] = $data;
